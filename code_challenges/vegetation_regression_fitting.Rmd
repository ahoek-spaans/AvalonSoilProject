...
# the "~" indicates a relative path i.e. a folder path that is potentially shared across computers, but with different user names
...
nd = with(veg, expand.grid(SprTmax = seq(8, 20, by = 2),
